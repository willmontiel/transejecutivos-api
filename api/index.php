...
function authenticate(\Slim\Route $route) {
    ...
    if (isset($headers['AUTHORIZATION'])) {
        ...
        if (!$db->isValidApiKey($api_key)) {
            ...
            $response["error"] = true;
            $response["message"] = "Acceso denegado, apikey invalida";
        ...
        $response["error"] = true;
        $response["message"] = "apikey no encontrada";
...
$app->post('/login', function() use ($app) {
    ...
    try {
        ...
        $response["error"] = true;
        $response["message"] = "Ocurrió un error, por favor contacta al administrador";
...
$app->post('/traceservice/:id', 'authenticate', function($id) use($app) {
    ...
    try {
        ...
        if ($result) {
            $response["error"] = false;
            $response["message"] = "Se ha guardado el segumiento exitosamente";
        } else {
            $response["error"] = true;
            $response["message"] = "Ha ocurrido un error, por favor intenta más tarde";
        }
